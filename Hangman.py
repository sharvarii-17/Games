...
samples = """apple banana mango strawberry 
orange grape pineapple apricot lemon coconut watermelon 
cherry papaya berry peach lychee muskmelon"""

samples = samples.split(" ")
# randomly choose a secret word from our "samples" list.
fruit = random.choice(samples)
...
if __name__ == "__main__":
    ...
    try:
        ...
        if chances <= 0 and (Counter(letterGuessed) != Counter(fruit)):
            ...
            print("The fruit name was {}".format(fruit))
